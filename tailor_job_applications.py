...
def create_and_run_crew():
    ...
    # Print the contents of the tailored resume
    with open("tailored_resume.md", "r") as file:
...
def main():
    print("Starting the job application tailoring process...")
    result = create_and_run_crew()
