...
def create_tasks():
    ...
    data_analyst_agent, trading_strategy_agent, execution_agent, risk_management_agent = agents
...
def run_crew(financial_trading_inputs):
    # Create agents and tasks
    agents = create_agents()
    tasks = create_tasks()
    
    # Define and create the crew with agents and tasks
    ...
    # Run the crew
    print("Running the financial trading crew. This may take some time...")
...
def main():
    ...
    # Run the crew
    run_crew(financial_trading_inputs)
